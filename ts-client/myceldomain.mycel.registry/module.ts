...
import { DomainOwnership as typeDomainOwnership} from "./types"
import { Params as typeParams} from "./types"

export { MsgUpdateWalletRecord, MsgUpdateDnsRecord, MsgRegisterDomain };
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		msgUpdateWalletRecord({ value }: msgUpdateWalletRecordParams): EncodeObject {
			try {
				return { typeUrl: "/myceldomain.mycel.registry.MsgUpdateWalletRecord", value: MsgUpdateWalletRecord.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgUpdateDnsRecord({ value }: msgUpdateDnsRecordParams): EncodeObject {
			try {
				return { typeUrl: "/myceldomain.mycel.registry.MsgUpdateDnsRecord", value: MsgUpdateDnsRecord.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgRegisterDomain({ value }: msgRegisterDomainParams): EncodeObject {
			try {
				return { typeUrl: "/myceldomain.mycel.registry.MsgRegisterDomain", value: MsgRegisterDomain.fromPartial( value ) }  
			} catch (e: any) {
...
class SDKModule {
	...
	constructor(client: IgniteClient) {		
		...
		this.structure =  {
						...
						DomainOwnership: getStructure(typeDomainOwnership.fromPartial({})),
...
const Module = (test: IgniteClient) => {
	return {
		module: {
			MyceldomainMycelRegistry: new SDKModule(test)
		},
		registry: msgTypes
  }
}
