...
export class MsgClientImpl implements Msg {
  ...
  UpdateWalletRecord(request: MsgUpdateWalletRecord): Promise<MsgUpdateWalletRecordResponse> {
    ...
    const promise = this.rpc.request("myceldomain.mycel.registry.Msg", "UpdateWalletRecord", data);
  ...
  UpdateDnsRecord(request: MsgUpdateDnsRecord): Promise<MsgUpdateDnsRecordResponse> {
    ...
    const promise = this.rpc.request("myceldomain.mycel.registry.Msg", "UpdateDnsRecord", data);
  ...
  RegisterDomain(request: MsgRegisterDomain): Promise<MsgRegisterDomainResponse> {
    ...
    const promise = this.rpc.request("myceldomain.mycel.registry.Msg", "RegisterDomain", data);
