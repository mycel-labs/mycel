...
export interface QueryDomainRegistrationFeeRequest {
  name: string;
  parent: string;
}

export interface QueryDomainRegistrationFeeResponse {
...
function createBaseQueryDomainRegistrationFeeRequest(): QueryDomainRegistrationFeeRequest {
  return { name: "", parent: "" };
}

export const QueryDomainRegistrationFeeRequest = {
  encode(message: QueryDomainRegistrationFeeRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    if (message.parent !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryDomainRegistrationFeeRequest {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryDomainRegistrationFeeRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): QueryDomainRegistrationFeeRequest {
    return {
      name: isSet(object.name) ? String(object.name) : "",
      parent: isSet(object.parent) ? String(object.parent) : "",
    };
  ...
  toJSON(message: QueryDomainRegistrationFeeRequest): unknown {
    const obj: any = {};
    message.name !== undefined && (obj.name = message.name);
    message.parent !== undefined && (obj.parent = message.parent);
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<QueryDomainRegistrationFeeRequest>, I>>(
    object: I,
  ): QueryDomainRegistrationFeeRequest {
    const message = createBaseQueryDomainRegistrationFeeRequest();
    message.name = object.name ?? "";
    message.parent = object.parent ?? "";
    return message;
...
function createBaseQueryDomainRegistrationFeeResponse(): QueryDomainRegistrationFeeResponse {
  return { amount: undefined };
}

export const QueryDomainRegistrationFeeResponse = {
  encode(message: QueryDomainRegistrationFeeResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryDomainRegistrationFeeResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryDomainRegistrationFeeResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): QueryDomainRegistrationFeeResponse {
    return { amount: isSet(object.amount) ? Coin.fromJSON(object.amount) : undefined };
  },

  toJSON(message: QueryDomainRegistrationFeeResponse): unknown {
    const obj: any = {};
    message.amount !== undefined && (obj.amount = message.amount ? Coin.toJSON(message.amount) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<QueryDomainRegistrationFeeResponse>, I>>(
    object: I,
...
export interface Query {
  ...
  DomainRegistrationFee(request: QueryDomainRegistrationFeeRequest): Promise<QueryDomainRegistrationFeeResponse>;
}
...
export class QueryClientImpl implements Query {
  ...
  constructor(rpc: Rpc) {
    ...
    this.DomainRegistrationFee = this.DomainRegistrationFee.bind(this);
  }
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
  ...
  DomainOwnership(request: QueryGetDomainOwnershipRequest): Promise<QueryGetDomainOwnershipResponse> {
    ...
    const promise = this.rpc.request("mycel.registry.Query", "DomainOwnership", data);
  ...
  DomainOwnershipAll(request: QueryAllDomainOwnershipRequest): Promise<QueryAllDomainOwnershipResponse> {
    ...
    const promise = this.rpc.request("mycel.registry.Query", "DomainOwnershipAll", data);
    return promise.then((data) => QueryAllDomainOwnershipResponse.decode(new _m0.Reader(data)));
  }

  DomainRegistrationFee(request: QueryDomainRegistrationFeeRequest): Promise<QueryDomainRegistrationFeeResponse> {
    const data = QueryDomainRegistrationFeeRequest.encode(request).finish();
    const promise = this.rpc.request("mycel.registry.Query", "DomainRegistrationFee", data);
    return promise.then((data) => QueryDomainRegistrationFeeResponse.decode(new _m0.Reader(data)));
  }
}
