...
func (x *fastReflection_EpochInfo) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "mycel.epochs.EpochInfo.identifier":
		return x.Identifier != ""
	case "mycel.epochs.EpochInfo.start_time":
		return x.StartTime != nil
	case "mycel.epochs.EpochInfo.duration":
		return x.Duration != nil
	case "mycel.epochs.EpochInfo.current_epoch":
		return x.CurrentEpoch != int64(0)
	case "mycel.epochs.EpochInfo.current_epoch_start_time":
		return x.CurrentEpochStartTime != nil
	case "mycel.epochs.EpochInfo.epoch_counting_started":
		return x.EpochCountingStarted != false
	case "mycel.epochs.EpochInfo.current_epoch_start_height":
...
func (x *fastReflection_EpochInfo) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "mycel.epochs.EpochInfo.current_epoch":
		panic(fmt.Errorf("field current_epoch of message mycel.epochs.EpochInfo is not mutable"))
	case "mycel.epochs.EpochInfo.epoch_counting_started":
		panic(fmt.Errorf("field epoch_counting_started of message mycel.epochs.EpochInfo is not mutable"))
	case "mycel.epochs.EpochInfo.current_epoch_start_height":
		panic(fmt.Errorf("field current_epoch_start_height of message mycel.epochs.EpochInfo is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: mycel.epochs.EpochInfo"))
		}
...
var file_mycel_epochs_epoch_info_proto_rawDesc = []byte{
	...
	,
...
var file_mycel_epochs_epoch_info_proto_depIdxs = []int32{
	1, // 0: mycel.epochs.EpochInfo.start_time:type_name -> google.protobuf.Timestamp
	2, // 1: mycel.epochs.EpochInfo.duration:type_name -> google.protobuf.Duration
	1, // 2: mycel.epochs.EpochInfo.current_epoch_start_time:type_name -> google.protobuf.Timestamp
