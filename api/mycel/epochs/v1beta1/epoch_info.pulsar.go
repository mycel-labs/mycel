...
var (
	...
	fd_EpochInfo_startTime               protoreflect.FieldDescriptor
	fd_EpochInfo_duration                protoreflect.FieldDescriptor
	fd_EpochInfo_currentEpoch            protoreflect.FieldDescriptor
	fd_EpochInfo_currentEpochStartTime   protoreflect.FieldDescriptor
	fd_EpochInfo_epochCountingStarted    protoreflect.FieldDescriptor
	fd_EpochInfo_currentEpochStartHeight protoreflect.FieldDescriptor
)

func init() {
	file_mycel_epochs_v1beta1_epoch_info_proto_init()
	md_EpochInfo = File_mycel_epochs_v1beta1_epoch_info_proto.Messages().ByName("EpochInfo")
	fd_EpochInfo_identifier = md_EpochInfo.Fields().ByName("identifier")
	fd_EpochInfo_startTime = md_EpochInfo.Fields().ByName("startTime")
	fd_EpochInfo_duration = md_EpochInfo.Fields().ByName("duration")
	fd_EpochInfo_currentEpoch = md_EpochInfo.Fields().ByName("currentEpoch")
	fd_EpochInfo_currentEpochStartTime = md_EpochInfo.Fields().ByName("currentEpochStartTime")
	fd_EpochInfo_epochCountingStarted = md_EpochInfo.Fields().ByName("epochCountingStarted")
	fd_EpochInfo_currentEpochStartHeight = md_EpochInfo.Fields().ByName("currentEpochStartHeight")
}
...
func (x *EpochInfo) slowProtoReflect() protoreflect.Message {
	mi := &file_mycel_epochs_v1beta1_epoch_info_proto_msgTypes[0]
...
func (x *fastReflection_EpochInfo) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.StartTime != nil {
		...
		if !f(fd_EpochInfo_startTime, value) {
			return
		}
	}
	if x.Duration != nil {
...
func (x *fastReflection_EpochInfo) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "mycel.epochs.EpochInfo.identifier":
		return x.Identifier != ""
	case "mycel.epochs.EpochInfo.startTime":
		return x.StartTime != nil
	case "mycel.epochs.EpochInfo.duration":
		return x.Duration != nil
	case "mycel.epochs.EpochInfo.currentEpoch":
		return x.CurrentEpoch != int64(0)
	case "mycel.epochs.EpochInfo.currentEpochStartTime":
		return x.CurrentEpochStartTime != nil
	case "mycel.epochs.EpochInfo.epochCountingStarted":
		return x.EpochCountingStarted != false
	case "mycel.epochs.EpochInfo.currentEpochStartHeight":
		return x.CurrentEpochStartHeight != int64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: mycel.epochs.EpochInfo"))
		}
		panic(fmt.Errorf("message mycel.epochs.EpochInfo does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_EpochInfo) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message mycel.epochs.EpochInfo does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_EpochInfo) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "mycel.epochs.EpochInfo.identifier":
		panic(fmt.Errorf("field identifier of message mycel.epochs.EpochInfo is not mutable"))
	case "mycel.epochs.EpochInfo.currentEpoch":
		panic(fmt.Errorf("field currentEpoch of message mycel.epochs.EpochInfo is not mutable"))
	case "mycel.epochs.EpochInfo.epochCountingStarted":
		panic(fmt.Errorf("field epochCountingStarted of message mycel.epochs.EpochInfo is not mutable"))
	case "mycel.epochs.EpochInfo.currentEpochStartHeight":
		panic(fmt.Errorf("field currentEpochStartHeight of message mycel.epochs.EpochInfo is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: mycel.epochs.EpochInfo"))
		}
...
func (x *fastReflection_EpochInfo) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in mycel.epochs.EpochInfo", d.FullName()))
	}
	panic("unreachable")
}
...
type EpochInfo struct {
	...
	CurrentEpochStartTime   *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=currentEpochStartTime,proto3" json:"currentEpochStartTime,omitempty"`
...
func (*EpochInfo) Descriptor() ([]byte, []int) {
	return file_mycel_epochs_v1beta1_epoch_info_proto_rawDescGZIP(), []int{0}
}
...
var File_mycel_epochs_v1beta1_epoch_info_proto protoreflect.FileDescriptor

var file_mycel_epochs_v1beta1_epoch_info_proto_rawDesc = []byte{
	0x0a, 0x25, 0x6d, 0x79, 0x63, 0x65, 0x6c, 0x2f, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x73, 0x2f, 0x76,
	0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x5f, 0x69, 0x6e, 0x66,
	0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0c, 0x6d, 0x79, 0x63, 0x65, 0x6c, 0x2e, 0x65,
	0x70, 0x6f, 0x63, 0x68, 0x73, 0x1a, 0x14, 0x67, 0x6f, 0x67, 0x6f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	...
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xff, 0x03, 0x0a,
	0x09, 0x45, 0x70, 0x6f, 0x63, 0x68, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1e, 0x0a, 0x0a, 0x69, 0x64,
	0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a,
	0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x57, 0x0a, 0x09, 0x73, 0x74,
	...
	0x69, 0x6d, 0x65, 0x12, 0x68, 0x0a, 0x08, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18,
	...
	0xdf, 0x1f, 0x01, 0x52, 0x08, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x22, 0x0a,
	...
	,
...
var (
	file_mycel_epochs_v1beta1_epoch_info_proto_rawDescOnce sync.Once
	file_mycel_epochs_v1beta1_epoch_info_proto_rawDescData = file_mycel_epochs_v1beta1_epoch_info_proto_rawDesc
)

func file_mycel_epochs_v1beta1_epoch_info_proto_rawDescGZIP() []byte {
	file_mycel_epochs_v1beta1_epoch_info_proto_rawDescOnce.Do(func() {
		file_mycel_epochs_v1beta1_epoch_info_proto_rawDescData = protoimpl.X.CompressGZIP(file_mycel_epochs_v1beta1_epoch_info_proto_rawDescData)
	})
	return file_mycel_epochs_v1beta1_epoch_info_proto_rawDescData
}

var file_mycel_epochs_v1beta1_epoch_info_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_mycel_epochs_v1beta1_epoch_info_proto_goTypes = []interface{}{
	(*EpochInfo)(nil),             // 0: mycel.epochs.EpochInfo
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),   // 2: google.protobuf.Duration
}
var file_mycel_epochs_v1beta1_epoch_info_proto_depIdxs = []int32{
	1, // 0: mycel.epochs.EpochInfo.startTime:type_name -> google.protobuf.Timestamp
	2, // 1: mycel.epochs.EpochInfo.duration:type_name -> google.protobuf.Duration
	1, // 2: mycel.epochs.EpochInfo.currentEpochStartTime:type_name -> google.protobuf.Timestamp
...
func init() { file_mycel_epochs_v1beta1_epoch_info_proto_init() }
func file_mycel_epochs_v1beta1_epoch_info_proto_init() {
	if File_mycel_epochs_v1beta1_epoch_info_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_mycel_epochs_v1beta1_epoch_info_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_mycel_epochs_v1beta1_epoch_info_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mycel_epochs_v1beta1_epoch_info_proto_goTypes,
		DependencyIndexes: file_mycel_epochs_v1beta1_epoch_info_proto_depIdxs,
		MessageInfos:      file_mycel_epochs_v1beta1_epoch_info_proto_msgTypes,
	}.Build()
	File_mycel_epochs_v1beta1_epoch_info_proto = out.File
	file_mycel_epochs_v1beta1_epoch_info_proto_rawDesc = nil
	file_mycel_epochs_v1beta1_epoch_info_proto_goTypes = nil
	file_mycel_epochs_v1beta1_epoch_info_proto_depIdxs = nil
}
