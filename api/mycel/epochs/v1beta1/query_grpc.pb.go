...
const (
	Query_Params_FullMethodName       = "/mycel.epochs.Query/Params"
	Query_EpochInfo_FullMethodName    = "/mycel.epochs.Query/EpochInfo"
	Query_EpochInfoAll_FullMethodName = "/mycel.epochs.Query/EpochInfoAll"
)
