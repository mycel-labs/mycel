...
func init() {
	...
	md_EpochInfo = File_mycel_epochs_v1_epoch_info_proto.Messages().ByName("EpochInfo")
...
func (x *EpochInfo) slowProtoReflect() protoreflect.Message {
	mi := &file_mycel_epochs_v1_epoch_info_proto_msgTypes[0]
...
func (x *fastReflection_EpochInfo) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "mycel.epochs.v1.EpochInfo.identifier":
		return x.Identifier != ""
	case "mycel.epochs.v1.EpochInfo.start_time":
		return x.StartTime != nil
	case "mycel.epochs.v1.EpochInfo.duration":
		return x.Duration != nil
	case "mycel.epochs.v1.EpochInfo.current_epoch":
		return x.CurrentEpoch != int64(0)
	case "mycel.epochs.v1.EpochInfo.current_epoch_start_time":
		return x.CurrentEpochStartTime != nil
	case "mycel.epochs.v1.EpochInfo.epoch_counting_started":
		return x.EpochCountingStarted != false
	case "mycel.epochs.v1.EpochInfo.current_epoch_start_height":
		return x.CurrentEpochStartHeight != int64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: mycel.epochs.v1.EpochInfo"))
		}
		panic(fmt.Errorf("message mycel.epochs.v1.EpochInfo does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_EpochInfo) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message mycel.epochs.v1.EpochInfo does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_EpochInfo) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "mycel.epochs.v1.EpochInfo.identifier":
		panic(fmt.Errorf("field identifier of message mycel.epochs.v1.EpochInfo is not mutable"))
	case "mycel.epochs.v1.EpochInfo.current_epoch":
		panic(fmt.Errorf("field current_epoch of message mycel.epochs.v1.EpochInfo is not mutable"))
	case "mycel.epochs.v1.EpochInfo.epoch_counting_started":
		panic(fmt.Errorf("field epoch_counting_started of message mycel.epochs.v1.EpochInfo is not mutable"))
	case "mycel.epochs.v1.EpochInfo.current_epoch_start_height":
		panic(fmt.Errorf("field current_epoch_start_height of message mycel.epochs.v1.EpochInfo is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: mycel.epochs.v1.EpochInfo"))
		}
...
func (x *fastReflection_EpochInfo) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in mycel.epochs.v1.EpochInfo", d.FullName()))
	}
	panic("unreachable")
}
...
func (*EpochInfo) Descriptor() ([]byte, []int) {
	return file_mycel_epochs_v1_epoch_info_proto_rawDescGZIP(), []int{0}
}
...
var File_mycel_epochs_v1_epoch_info_proto protoreflect.FileDescriptor

var file_mycel_epochs_v1_epoch_info_proto_rawDesc = []byte{
	0x0a, 0x20, 0x6d, 0x79, 0x63, 0x65, 0x6c, 0x2f, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x73, 0x2f, 0x76,
	0x31, 0x2f, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x12, 0x0f, 0x6d, 0x79, 0x63, 0x65, 0x6c, 0x2e, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x73,
	...
	0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8a, 0x04, 0x0a, 0x09, 0x45,
	...
	0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x58, 0x0a, 0x0a, 0x73, 0x74, 0x61, 0x72,
	...
	0x6d, 0x65, 0x12, 0x68, 0x0a, 0x08, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x44, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42,
	0x31, 0xc8, 0xde, 0x1f, 0x00, 0xea, 0xde, 0x1f, 0x12, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x2c, 0x6f, 0x6d, 0x69, 0x74, 0x65, 0x6d, 0x70, 0x74, 0x79, 0xf2, 0xde, 0x1f, 0x0f, 0x79,
	...
	0x68, 0x12, 0x80, 0x01, 0x0a, 0x18, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x5f, 0x65, 0x70,
	0x6f, 0x63, 0x68, 0x5f, 0x73, 0x74, 0x61, 0x72, 0x74, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70,
	0x42, 0x2b, 0xc8, 0xde, 0x1f, 0x00, 0xf2, 0xde, 0x1f, 0x1f, 0x79, 0x61, 0x6d, 0x6c, 0x3a, 0x22,
	0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x5f, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x5f, 0x73, 0x74,
	0x61, 0x72, 0x74, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x22, 0x90, 0xdf, 0x1f, 0x01, 0x52, 0x15, 0x63,
	...
	,
}

var (
	file_mycel_epochs_v1_epoch_info_proto_rawDescOnce sync.Once
	file_mycel_epochs_v1_epoch_info_proto_rawDescData = file_mycel_epochs_v1_epoch_info_proto_rawDesc
)

func file_mycel_epochs_v1_epoch_info_proto_rawDescGZIP() []byte {
	file_mycel_epochs_v1_epoch_info_proto_rawDescOnce.Do(func() {
		file_mycel_epochs_v1_epoch_info_proto_rawDescData = protoimpl.X.CompressGZIP(file_mycel_epochs_v1_epoch_info_proto_rawDescData)
	})
	return file_mycel_epochs_v1_epoch_info_proto_rawDescData
}

var file_mycel_epochs_v1_epoch_info_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_mycel_epochs_v1_epoch_info_proto_goTypes = []interface{}{
	(*EpochInfo)(nil),             // 0: mycel.epochs.v1.EpochInfo
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),   // 2: google.protobuf.Duration
}
var file_mycel_epochs_v1_epoch_info_proto_depIdxs = []int32{
	1, // 0: mycel.epochs.v1.EpochInfo.start_time:type_name -> google.protobuf.Timestamp
	2, // 1: mycel.epochs.v1.EpochInfo.duration:type_name -> google.protobuf.Duration
	1, // 2: mycel.epochs.v1.EpochInfo.current_epoch_start_time:type_name -> google.protobuf.Timestamp
...
func init() { file_mycel_epochs_v1_epoch_info_proto_init() }
func file_mycel_epochs_v1_epoch_info_proto_init() {
	if File_mycel_epochs_v1_epoch_info_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_mycel_epochs_v1_epoch_info_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_mycel_epochs_v1_epoch_info_proto_goTypes,
		DependencyIndexes: file_mycel_epochs_v1_epoch_info_proto_depIdxs,
		MessageInfos:      file_mycel_epochs_v1_epoch_info_proto_msgTypes,
	}.Build()
	File_mycel_epochs_v1_epoch_info_proto = out.File
	file_mycel_epochs_v1_epoch_info_proto_rawDesc = nil
	file_mycel_epochs_v1_epoch_info_proto_goTypes = nil
	file_mycel_epochs_v1_epoch_info_proto_depIdxs = nil
}
