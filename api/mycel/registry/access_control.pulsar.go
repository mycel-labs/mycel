...
func init() {
	...
	md_AccessControl = File_mycel_registry_access_control_proto.Messages().ByName("AccessControl")
...
func (x *AccessControl) slowProtoReflect() protoreflect.Message {
	mi := &file_mycel_registry_access_control_proto_msgTypes[0]
...
func (x *fastReflection_AccessControl) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "mycel.registry.AccessControl.address":
		return x.Address != ""
	case "mycel.registry.AccessControl.role":
		return x.Role != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: mycel.registry.AccessControl"))
		}
		panic(fmt.Errorf("message mycel.registry.AccessControl does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_AccessControl) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message mycel.registry.AccessControl does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_AccessControl) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "mycel.registry.AccessControl.address":
		panic(fmt.Errorf("field address of message mycel.registry.AccessControl is not mutable"))
	case "mycel.registry.AccessControl.role":
		panic(fmt.Errorf("field role of message mycel.registry.AccessControl is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: mycel.registry.AccessControl"))
		}
...
func (x *fastReflection_AccessControl) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in mycel.registry.AccessControl", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: mycel/registry/access_control.proto
...
func (DomainRole) Descriptor() protoreflect.EnumDescriptor {
	return file_mycel_registry_access_control_proto_enumTypes[0].Descriptor()
}

func (DomainRole) Type() protoreflect.EnumType {
	return &file_mycel_registry_access_control_proto_enumTypes[0]
}
...
func (DomainRole) EnumDescriptor() ([]byte, []int) {
	return file_mycel_registry_access_control_proto_rawDescGZIP(), []int{0}
}
...
var File_mycel_registry_access_control_proto protoreflect.FileDescriptor

var file_mycel_registry_access_control_proto_rawDesc = []byte{
	...
	,
...
var (
	file_mycel_registry_access_control_proto_rawDescOnce sync.Once
	file_mycel_registry_access_control_proto_rawDescData = file_mycel_registry_access_control_proto_rawDesc
)

func file_mycel_registry_access_control_proto_rawDescGZIP() []byte {
	file_mycel_registry_access_control_proto_rawDescOnce.Do(func() {
		file_mycel_registry_access_control_proto_rawDescData = protoimpl.X.CompressGZIP(file_mycel_registry_access_control_proto_rawDescData)
	})
	return file_mycel_registry_access_control_proto_rawDescData
}

var file_mycel_registry_access_control_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_mycel_registry_access_control_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_mycel_registry_access_control_proto_goTypes = []interface{}{
	(DomainRole)(0),       // 0: mycel.registry.DomainRole
	(*AccessControl)(nil), // 1: mycel.registry.AccessControl
}
var file_mycel_registry_access_control_proto_depIdxs = []int32{
	0, // 0: mycel.registry.AccessControl.role:type_name -> mycel.registry.DomainRole
...
func init() { file_mycel_registry_access_control_proto_init() }
func file_mycel_registry_access_control_proto_init() {
	if File_mycel_registry_access_control_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_mycel_registry_access_control_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_mycel_registry_access_control_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mycel_registry_access_control_proto_goTypes,
		DependencyIndexes: file_mycel_registry_access_control_proto_depIdxs,
		EnumInfos:         file_mycel_registry_access_control_proto_enumTypes,
		MessageInfos:      file_mycel_registry_access_control_proto_msgTypes,
	}.Build()
	File_mycel_registry_access_control_proto = out.File
	file_mycel_registry_access_control_proto_rawDesc = nil
	file_mycel_registry_access_control_proto_goTypes = nil
	file_mycel_registry_access_control_proto_depIdxs = nil
}
