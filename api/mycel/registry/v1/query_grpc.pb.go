...
const (
	Query_Params_FullMethodName                = "/mycel.registry.v1.Query/Params"
	Query_TopLevelDomain_FullMethodName        = "/mycel.registry.v1.Query/TopLevelDomain"
	Query_TopLevelDomainAll_FullMethodName     = "/mycel.registry.v1.Query/TopLevelDomainAll"
	Query_SecondLevelDomain_FullMethodName     = "/mycel.registry.v1.Query/SecondLevelDomain"
	Query_SecondLevelDomainAll_FullMethodName  = "/mycel.registry.v1.Query/SecondLevelDomainAll"
	Query_DomainOwnership_FullMethodName       = "/mycel.registry.v1.Query/DomainOwnership"
	Query_DomainOwnershipAll_FullMethodName    = "/mycel.registry.v1.Query/DomainOwnershipAll"
	Query_DomainRegistrationFee_FullMethodName = "/mycel.registry.v1.Query/DomainRegistrationFee"
	Query_Role_FullMethodName                  = "/mycel.registry.v1.Query/Role"
	Query_WalletRecord_FullMethodName          = "/mycel.registry.v1.Query/WalletRecord"
	Query_DnsRecord_FullMethodName             = "/mycel.registry.v1.Query/DnsRecord"
	Query_AllRecords_FullMethodName            = "/mycel.registry.v1.Query/AllRecords"
	Query_TextRecord_FullMethodName            = "/mycel.registry.v1.Query/TextRecord"
)
