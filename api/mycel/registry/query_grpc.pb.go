...
const (
	Query_Params_FullMethodName                = "/mycel.registry.Query/Params"
	Query_TopLevelDomain_FullMethodName        = "/mycel.registry.Query/TopLevelDomain"
	Query_TopLevelDomainAll_FullMethodName     = "/mycel.registry.Query/TopLevelDomainAll"
	Query_SecondLevelDomain_FullMethodName     = "/mycel.registry.Query/SecondLevelDomain"
	Query_SecondLevelDomainAll_FullMethodName  = "/mycel.registry.Query/SecondLevelDomainAll"
	Query_DomainOwnership_FullMethodName       = "/mycel.registry.Query/DomainOwnership"
	Query_DomainOwnershipAll_FullMethodName    = "/mycel.registry.Query/DomainOwnershipAll"
	Query_DomainRegistrationFee_FullMethodName = "/mycel.registry.Query/DomainRegistrationFee"
	Query_Role_FullMethodName                  = "/mycel.registry.Query/Role"
	Query_WalletRecord_FullMethodName          = "/mycel.registry.Query/WalletRecord"
	Query_DnsRecord_FullMethodName             = "/mycel.registry.Query/DnsRecord"
	Query_AllRecords_FullMethodName            = "/mycel.registry.Query/AllRecords"
	Query_TextRecord_FullMethodName            = "/mycel.registry.Query/TextRecord"
)
