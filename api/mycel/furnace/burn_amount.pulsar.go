...
func (x *fastReflection_BurnAmount) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "mycel.furnace.BurnAmount.burn_started":
		return x.BurnStarted != false
	case "mycel.furnace.BurnAmount.total_epochs":
		return x.TotalEpochs != uint64(0)
	case "mycel.furnace.BurnAmount.current_epoch":
		return x.CurrentEpoch != uint64(0)
	case "mycel.furnace.BurnAmount.total_burn_amount":
		return x.TotalBurnAmount != nil
	case "mycel.furnace.BurnAmount.cumulative_burnt_amount":
...
func (x *fastReflection_BurnAmount) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "mycel.furnace.BurnAmount.burn_started":
		panic(fmt.Errorf("field burn_started of message mycel.furnace.BurnAmount is not mutable"))
	case "mycel.furnace.BurnAmount.total_epochs":
		panic(fmt.Errorf("field total_epochs of message mycel.furnace.BurnAmount is not mutable"))
	case "mycel.furnace.BurnAmount.current_epoch":
		panic(fmt.Errorf("field current_epoch of message mycel.furnace.BurnAmount is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: mycel.furnace.BurnAmount"))
		}
...
var file_mycel_furnace_burn_amount_proto_rawDesc = []byte{
	...
	0x65, 0x42, 0x75, 0x72, 0x6e, 0x74, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x99, 0x01, 0x0a,
	0x11, 0x63, 0x6f, 0x6d, 0x2e, 0x6d, 0x79, 0x63, 0x65, 0x6c, 0x2e, 0x66, 0x75, 0x72, 0x6e, 0x61,
	0x63, 0x65, 0x42, 0x0f, 0x42, 0x75, 0x72, 0x6e, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x50, 0x72,
	...
	0x72, 0x6e, 0x61, 0x63, 0x65, 0xa2, 0x02, 0x03, 0x4d, 0x46, 0x58, 0xaa, 0x02, 0x0d, 0x4d, 0x79,
	0x63, 0x65, 0x6c, 0x2e, 0x46, 0x75, 0x72, 0x6e, 0x61, 0x63, 0x65, 0xca, 0x02, 0x0d, 0x4d, 0x79,
	0x63, 0x65, 0x6c, 0x5c, 0x46, 0x75, 0x72, 0x6e, 0x61, 0x63, 0x65, 0xe2, 0x02, 0x19, 0x4d, 0x79,
	0x63, 0x65, 0x6c, 0x5c, 0x46, 0x75, 0x72, 0x6e, 0x61, 0x63, 0x65, 0x5c, 0x47, 0x50, 0x42, 0x4d,
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x0e, 0x4d, 0x79, 0x63, 0x65, 0x6c, 0x3a,
	0x3a, 0x46, 0x75, 0x72, 0x6e, 0x61, 0x63, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_mycel_furnace_burn_amount_proto_depIdxs = []int32{
	1, // 0: mycel.furnace.BurnAmount.total_burn_amount:type_name -> cosmos.base.v1beta1.Coin
	1, // 1: mycel.furnace.BurnAmount.cumulative_burnt_amount:type_name -> cosmos.base.v1beta1.Coin
