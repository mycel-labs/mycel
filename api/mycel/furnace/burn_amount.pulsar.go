...
var (
	...
	fd_BurnAmount_burnStarted           protoreflect.FieldDescriptor
	fd_BurnAmount_totalEpochs           protoreflect.FieldDescriptor
	fd_BurnAmount_currentEpoch          protoreflect.FieldDescriptor
	fd_BurnAmount_totalBurnAmount       protoreflect.FieldDescriptor
	fd_BurnAmount_cumulativeBurntAmount protoreflect.FieldDescriptor
)

func init() {
	file_mycel_furnace_burn_amount_proto_init()
	md_BurnAmount = File_mycel_furnace_burn_amount_proto.Messages().ByName("BurnAmount")
	fd_BurnAmount_index = md_BurnAmount.Fields().ByName("index")
	fd_BurnAmount_burnStarted = md_BurnAmount.Fields().ByName("burnStarted")
	fd_BurnAmount_totalEpochs = md_BurnAmount.Fields().ByName("totalEpochs")
	fd_BurnAmount_currentEpoch = md_BurnAmount.Fields().ByName("currentEpoch")
	fd_BurnAmount_totalBurnAmount = md_BurnAmount.Fields().ByName("totalBurnAmount")
	fd_BurnAmount_cumulativeBurntAmount = md_BurnAmount.Fields().ByName("cumulativeBurntAmount")
}
...
func (x *BurnAmount) slowProtoReflect() protoreflect.Message {
	mi := &file_mycel_furnace_burn_amount_proto_msgTypes[0]
...
func (x *fastReflection_BurnAmount) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "mycel.furnace.BurnAmount.index":
		return x.Index != uint64(0)
	case "mycel.furnace.BurnAmount.burnStarted":
		return x.BurnStarted != false
	case "mycel.furnace.BurnAmount.totalEpochs":
		return x.TotalEpochs != uint64(0)
	case "mycel.furnace.BurnAmount.currentEpoch":
		return x.CurrentEpoch != uint64(0)
	case "mycel.furnace.BurnAmount.totalBurnAmount":
		return x.TotalBurnAmount != nil
	case "mycel.furnace.BurnAmount.cumulativeBurntAmount":
		return x.CumulativeBurntAmount != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: mycel.furnace.BurnAmount"))
		}
		panic(fmt.Errorf("message mycel.furnace.BurnAmount does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_BurnAmount) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message mycel.furnace.BurnAmount does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_BurnAmount) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "mycel.furnace.BurnAmount.index":
		panic(fmt.Errorf("field index of message mycel.furnace.BurnAmount is not mutable"))
	case "mycel.furnace.BurnAmount.burnStarted":
		panic(fmt.Errorf("field burnStarted of message mycel.furnace.BurnAmount is not mutable"))
	case "mycel.furnace.BurnAmount.totalEpochs":
		panic(fmt.Errorf("field totalEpochs of message mycel.furnace.BurnAmount is not mutable"))
	case "mycel.furnace.BurnAmount.currentEpoch":
		panic(fmt.Errorf("field currentEpoch of message mycel.furnace.BurnAmount is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: mycel.furnace.BurnAmount"))
		}
...
func (x *fastReflection_BurnAmount) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in mycel.furnace.BurnAmount", d.FullName()))
	}
	panic("unreachable")
}
...
type BurnAmount struct {
	...
	TotalBurnAmount       *v1beta1.Coin `protobuf:"bytes,5,opt,name=totalBurnAmount,proto3" json:"totalBurnAmount,omitempty"`
	CumulativeBurntAmount *v1beta1.Coin `protobuf:"bytes,6,opt,name=cumulativeBurntAmount,proto3" json:"cumulativeBurntAmount,omitempty"`
}
...
func (*BurnAmount) Descriptor() ([]byte, []int) {
	return file_mycel_furnace_burn_amount_proto_rawDescGZIP(), []int{0}
}
...
var File_mycel_furnace_burn_amount_proto protoreflect.FileDescriptor

var file_mycel_furnace_burn_amount_proto_rawDesc = []byte{
	0x0a, 0x1f, 0x6d, 0x79, 0x63, 0x65, 0x6c, 0x2f, 0x66, 0x75, 0x72, 0x6e, 0x61, 0x63, 0x65, 0x2f,
	0x62, 0x75, 0x72, 0x6e, 0x5f, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x12, 0x0d, 0x6d, 0x79, 0x63, 0x65, 0x6c, 0x2e, 0x66, 0x75, 0x72, 0x6e, 0x61, 0x63, 0x65,
	...
	,
...
var (
	file_mycel_furnace_burn_amount_proto_rawDescOnce sync.Once
	file_mycel_furnace_burn_amount_proto_rawDescData = file_mycel_furnace_burn_amount_proto_rawDesc
)

func file_mycel_furnace_burn_amount_proto_rawDescGZIP() []byte {
	file_mycel_furnace_burn_amount_proto_rawDescOnce.Do(func() {
		file_mycel_furnace_burn_amount_proto_rawDescData = protoimpl.X.CompressGZIP(file_mycel_furnace_burn_amount_proto_rawDescData)
	})
	return file_mycel_furnace_burn_amount_proto_rawDescData
}

var file_mycel_furnace_burn_amount_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_mycel_furnace_burn_amount_proto_goTypes = []interface{}{
	(*BurnAmount)(nil),   // 0: mycel.furnace.BurnAmount
	(*v1beta1.Coin)(nil), // 1: cosmos.base.v1beta1.Coin
}
var file_mycel_furnace_burn_amount_proto_depIdxs = []int32{
	1, // 0: mycel.furnace.BurnAmount.totalBurnAmount:type_name -> cosmos.base.v1beta1.Coin
	1, // 1: mycel.furnace.BurnAmount.cumulativeBurntAmount:type_name -> cosmos.base.v1beta1.Coin
...
func init() { file_mycel_furnace_burn_amount_proto_init() }
func file_mycel_furnace_burn_amount_proto_init() {
	if File_mycel_furnace_burn_amount_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_mycel_furnace_burn_amount_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_mycel_furnace_burn_amount_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mycel_furnace_burn_amount_proto_goTypes,
		DependencyIndexes: file_mycel_furnace_burn_amount_proto_depIdxs,
		MessageInfos:      file_mycel_furnace_burn_amount_proto_msgTypes,
	}.Build()
	File_mycel_furnace_burn_amount_proto = out.File
	file_mycel_furnace_burn_amount_proto_rawDesc = nil
	file_mycel_furnace_burn_amount_proto_goTypes = nil
	file_mycel_furnace_burn_amount_proto_depIdxs = nil
}
