...
const (
	Query_Params_FullMethodName       = "/mycel.resolver.v1beta1.Query/Params"
	Query_WalletRecord_FullMethodName = "/mycel.resolver.v1beta1.Query/WalletRecord"
	Query_DnsRecord_FullMethodName    = "/mycel.resolver.v1beta1.Query/DnsRecord"
	Query_AllRecords_FullMethodName   = "/mycel.resolver.v1beta1.Query/AllRecords"
	Query_TextRecord_FullMethodName   = "/mycel.resolver.v1beta1.Query/TextRecord"
)
