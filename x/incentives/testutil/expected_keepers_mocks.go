...
// Source: x/incentives/types/expected_keepers.go

// Package testutil is a generated GoMock package.
package testutil

import (
	types1 "mycel/x/epochs/types"
	reflect "reflect"
...
func (m *MockEpochsKeeper) GetEpochInfo(ctx types.Context, identifier string) (types1.EpochInfo, bool) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEpochInfo", ctx, identifier)
	ret0, _ := ret[0].(types1.EpochInfo)
	ret1, _ := ret[1].(bool)
	return ret0, ret1
}
