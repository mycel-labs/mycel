...
func (k Keeper) SetDomainOwnership(ctx context.Context, domainOwnership types.DomainOwnership) {
...
func (k Keeper) GetAllDomainOwnership(ctx context.Context) (list []types.DomainOwnership) {
	storeAdapter := runtime.KVStoreAdapter(k.storeService.OpenKVStore(ctx))
	store := prefix.NewStore(storeAdapter, types.KeyPrefix(types.DomainOwnershipKeyPrefix))
