...
type SubdomainRole int32

const (
	SubdomainRole_OWNER         SubdomainRole = 0
	SubdomainRole_RECORD_EDITOR SubdomainRole = 1
)

var SubdomainRole_name = map[int32]string{
	0: "OWNER",
	1: "RECORD_EDITOR",
}

var SubdomainRole_value = map[string]int32{
	"OWNER":         0,
	"RECORD_EDITOR": 1,
}

func (x SubdomainRole) String() string {
	return proto.EnumName(SubdomainRole_name, int32(x))
}

func (SubdomainRole) EnumDescriptor() ([]byte, []int) {
...
type SecondLevelDomain struct {
	...
	AccessControl  map[string]SubdomainRole `protobuf:"bytes,8,rep,name=accessControl,proto3" json:"accessControl,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3,enum=mycel.registry.SubdomainRole"`
}
...
func init() {
	proto.RegisterEnum("mycel.registry.SubdomainRole", SubdomainRole_name, SubdomainRole_value)
...
var fileDescriptor_71a2ae6361ebd509 = []byte{
	...
	,
}
			...
			for iNdEx < postIndex {
				...
				if fieldNum == 1 {
					...
					for shift := uint(0); ; shift += 7 {
						...
						b := dAtA[iNdEx]
						iNdEx++
						mapvalue |= SubdomainRole(b&0x7F) << shift
						if b < 0x80 {
							break
						}
					}
