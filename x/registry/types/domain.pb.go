...
type DnsRecord struct {
	DnsRecordType   DnsRecordType   `protobuf:"varint,1,opt,name=dnsRecordType,proto3,enum=myceldomain.mycel.registry.DnsRecordType" json:"dnsRecordType,omitempty"`
	DnsRecordFormat DnsRecordFormat `protobuf:"varint,2,opt,name=dnsRecordFormat,proto3,enum=myceldomain.mycel.registry.DnsRecordFormat" json:"dnsRecordFormat,omitempty"`
...
type WalletRecord struct {
	WalletRecordType    WalletRecordType    `protobuf:"varint,1,opt,name=walletRecordType,proto3,enum=myceldomain.mycel.registry.WalletRecordType" json:"walletRecordType,omitempty"`
	WalletAddressFormat WalletAddressFormat `protobuf:"varint,2,opt,name=walletAddressFormat,proto3,enum=myceldomain.mycel.registry.WalletAddressFormat" json:"walletAddressFormat,omitempty"`
	Value               string              `protobuf:"bytes,3,opt,name=value,proto3" json:"value,omitempty"`
}
...
func init() {
	proto.RegisterEnum("myceldomain.mycel.registry.DnsRecordType", DnsRecordType_name, DnsRecordType_value)
	proto.RegisterEnum("myceldomain.mycel.registry.DnsRecordFormat", DnsRecordFormat_name, DnsRecordFormat_value)
	proto.RegisterEnum("myceldomain.mycel.registry.WalletRecordType", WalletRecordType_name, WalletRecordType_value)
	proto.RegisterEnum("myceldomain.mycel.registry.WalletAddressFormat", WalletAddressFormat_name, WalletAddressFormat_value)
	proto.RegisterType((*DnsRecord)(nil), "myceldomain.mycel.registry.DnsRecord")
	proto.RegisterType((*WalletRecord)(nil), "myceldomain.mycel.registry.WalletRecord")
	proto.RegisterType((*Domain)(nil), "myceldomain.mycel.registry.Domain")
	proto.RegisterMapType((map[string]*DnsRecord)(nil), "myceldomain.mycel.registry.Domain.DnsRecordsEntry")
	proto.RegisterMapType((map[string]string)(nil), "myceldomain.mycel.registry.Domain.MetadataEntry")
	proto.RegisterMapType((map[string]*WalletRecord)(nil), "myceldomain.mycel.registry.Domain.WalletRecordsEntry")
}
...
var fileDescriptor_cfd012ed897e4b87 = []byte{
	...
	,
}
