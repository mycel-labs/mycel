...
type MsgSubmitTopLevelDomainProposal struct {
	Creator                  string `protobuf:"bytes,1,opt,name=creator,proto3" json:"creator,omitempty"`
	Name                     string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	RegistrationPeriodInYear string `protobuf:"bytes,3,opt,name=registrationPeriodInYear,proto3" json:"registrationPeriodInYear,omitempty"`
}
...
func (m *MsgSubmitTopLevelDomainProposal) GetRegistrationPeriodInYear() string {
	if m != nil {
		return m.RegistrationPeriodInYear
	}
	return ""
...
var fileDescriptor_7a4e7619dfc6612f = []byte{
	...
	,
}
...
func (m *MsgSubmitTopLevelDomainProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.RegistrationPeriodInYear) > 0 {
		i -= len(m.RegistrationPeriodInYear)
		copy(dAtA[i:], m.RegistrationPeriodInYear)
		i = encodeVarintTx(dAtA, i, uint64(len(m.RegistrationPeriodInYear)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Name) > 0 {
...
func (m *MsgSubmitTopLevelDomainProposal) Size() (n int) {
	...
	l = len(m.RegistrationPeriodInYear)
	if l > 0 {
		n += 1 + l + sovTx(uint64(l))
	}
	return n
...
func (m *MsgSubmitTopLevelDomainProposal) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.RegistrationPeriodInYear = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTx(dAtA[iNdEx:])
