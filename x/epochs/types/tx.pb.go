...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_61c872a7fa5480b2, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_61c872a7fa5480b2, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "mycel.epochs.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "mycel.epochs.MsgUpdateParamsResponse")
}
...
var fileDescriptor_61c872a7fa5480b2 = []byte{
	...
	0x51, 0x37, 0x25, 0x3f, 0x37, 0x31, 0x33, 0x4f, 0x1f, 0xcd, 0x43, 0x25, 0x95, 0x05, 0xa9, 0xc5,
	0x49, 0x6c, 0xe0, 0x58, 0x30, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x6a, 0x33, 0x33, 0x02, 0x24,
	0x02, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mycel.epochs.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mycel.epochs.Msg/UpdateParams",
	}
